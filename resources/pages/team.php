            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="well well-lg" id="studad">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <img src="../resources/team_photos/Navaraja.jpg" alt="" class="img-rounded" height="110" width="110" />
                            </div>
                            <div class="col-md-6" style="padding-right:0px;">
                                <blockquote>
                                    <p>Navaraja A T</p> <small><cite title="Source Title">Mechanical Engg</cite></small>
                                </blockquote>
                                <p style="font-size:12px;"> <i class="fa fa-envelope"> </i> 
                                </br><i class="fa fa-phone"> +91 - 99339 - 29179</i></p> 
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="well well-lg" id="electronics">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="padding-right:0px;">
                                <blockquote>
                                    <p>Vishnu Sharma</p> <small><cite title="Source Title">Electronics and Communication Engg</cite></small>
                                </blockquote>
                                <!--p style="font-size:12px;"> <i class="fa fa-envelope"> vinayyadav3016@gmail.com</i> 
                                </br><i class="fa fa-phone"> +91 - 3222 - 282934</i> </p-->
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="padding-right:0px;">
                                <blockquote>
                                    <p>Aniket Bhushan</p> <small><cite title="Source Title">Mechanical Engg</cite></small>
                                </blockquote>
                                <!--p style="font-size:12px;"> <i class="fa fa-envelope"> anuragiitkgp100@gmail.com</i> 
                                </br><i class="fa fa-phone"> +91 - 3222 - 282934</i></p--> 
                            </div>
                            ...
                            <div class="col-md-4" style="padding-right:0px;">
                                <blockquote>
                                    <p>Kshitij Goel</p> <small><cite title="Source Title">Aerospace Engg</cite></small>
                                </blockquote>
                                <!--p style="font-size:12px;"> <i class="fa fa-envelope"> vinayyadav3016@gmail.com</i> 
                                </br><i class="fa fa-phone"> +91 - 3222 - 282934</i> </p-->
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="padding-right:0px;">
                                <blockquote>
                                    <p>Sahashranshu Maurya</p> <small><cite title="Source Title">Geology and Geophysics</cite></small>
                                </blockquote>
                                <!--p style="font-size:12px;"> <i class="fa fa-envelope"> anuragiitkgp100@gmail.com</i> 
                                </br><i class="fa fa-phone"> +91 - 3222 - 282934</i></p--> 
                            </div>
